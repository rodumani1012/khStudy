...
<body class="is-preload">
	...
	<div id="content">
			...
			<article class="box post post-excerpt">
				<section class="box recent-posts">
					...
					<form action="project.do" method="post" onsubmit="se2()">
						...
						<input type="hidden" name="prj_num" value="${prj_info_dto.prj_num }">
						<table>
							<thead>
								...
								<tr>
									<th>프로젝트 이름</th>
									<td><input type="text" name="prj_name" value="${prj_info_dto.prj_name }"></td>
								</tr>

								<tr>
									<th>주소</th>
									<td><input type="text" class="text" name="prj_loc" id="address"
											placeholder="주소 검색 클릭" readonly="readonly" required /></td>
								</tr>
							...
							<tfoot>
								<tr>
									...
									<td colspan="5">
										<c:if test="${user_info_dto.user_nickname eq prj_info_dto.user_nickname }">
											...
											<input type="button" class="small" onclick="execDaumPostcode()"
												value="주소 검색">
		...
		<div class="map_wrap">
			<div id="map"></div>
			<div id="asd">
				<<<<<<< HEAD <input type="button" onclick="execDaumPostcode()" value="주소 검색"><br>
					=======
