		...
		<a href="#sidebar" class="toggle"></a> <span class="title"><a href="#">TOY</a></span>
			...
			<table id="calendar">
				<caption>
					 ...
					 <input type="button" class="small" value="이번달" onclick="location.href='calendar.do?command=calendar&prj_num=${prj_num_session }'">
				</caption>
				<tr>
...
%>
						<td>
							...
							<a href="calendar.do?command=cal_issue_insert&year=${calendar_map.year}&month=${calendar_map.month}&date=<%=i %>">
