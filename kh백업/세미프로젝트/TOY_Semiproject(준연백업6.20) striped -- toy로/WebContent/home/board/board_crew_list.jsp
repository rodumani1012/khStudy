			...
			<article class="box post post-excerpt">
				<section class="box recent-posts">
					...
					<table>
						...
						<tr>
							<td colspan="2"><input type="text" id="txt_search" value="${txt_search }"> <input
									type="button" class="small" value="검색"
									onclick="javascript:PageMove(${paging.pageNo})"> <input type="button" class="small"
									value="글쓰기"
