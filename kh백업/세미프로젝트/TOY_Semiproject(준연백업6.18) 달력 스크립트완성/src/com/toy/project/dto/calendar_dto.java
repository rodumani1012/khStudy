...
public class calendar_dto {
	...
	private Date issue_date_start; // 시작일
	...
	public calendar_dto(int issue_num, int prj_num, int board_num, String issue_title, String issue_content,
			int issue_require, String issue_charge, String issue_priority, Date issue_deadline, int issue_parent,
			Date issue_date_create, Date issue_date_start, String issue_del) {
		this.issue_num = issue_num;
		this.prj_num = prj_num;
		this.board_num = board_num;
		this.issue_title = issue_title;
		this.issue_content = issue_content;
		this.issue_require = issue_require;
	...
	public int getIssue_require() {
		return issue_require;
	}
	public void setIssue_require(int issue_require) {
		this.issue_require = issue_require;
	}
	...
	public Date getIssue_date_start() {
		return issue_date_start;
	}
	public void setIssue_date_start(Date issue_date_start) {
		this.issue_date_start = issue_date_start;
	}
