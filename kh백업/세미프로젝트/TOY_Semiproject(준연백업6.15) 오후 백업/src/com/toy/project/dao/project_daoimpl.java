...
public class project_daoimpl extends sql_map_config implements project_dao {
	...
	@Override
	public int prj_new(String prj_name, String invite_nick, int user_num, String prj_loc) {

		int res = 1;
		
		int invite_num = bring_num(invite_nick).getUser_num();
		System.out.println("초대할 분의 닉네임 : "+invite_nick+" 그 분의 회원번호 : "+invite_num);
