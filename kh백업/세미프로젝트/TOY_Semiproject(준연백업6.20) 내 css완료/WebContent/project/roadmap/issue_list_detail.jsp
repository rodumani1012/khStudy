			...
			<article class="box post post-excerpt">
				<section class="box recent-posts" style="width:900px;">
					...
					<table>
						...
						<tr>
							<td colspan="3">
							<input type="submit" class="small issue_list_detail" value="수정하기" />
							<input type="reset" class="small issue_list_detail" value="리셋">
							<input type="button" class="small issue_list_detail" value="취소" onclick="location.href='calendar.do?command=calendar_list&year=${year}&month=${month}&date=${date }'">
							<input type="button" class="small issue_list_detail" value="삭제" onclick="issue_delete()">
							</td>
						</tr>
					</table>
				</form>
