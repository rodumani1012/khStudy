		...
		<div class="inner">
			...
			<article class="box post post-excerpt">
				<section class="box recent-posts">
					...
					<form action="${pageContext.request.contextPath}/calendar.do?command=cal_issue_insert_res"
						method="post">
						<table>
							<tr>
								<th>카테고리 선택</th>
							...
							<tr>
								<th>이슈 내용</th>
								<td><textarea rows="10" cols="60" id="issue_content" name="issue_content"
							...
							<tr>
								<td colspan="3">
									<input type="submit" class="small issue_list_detail" value="작성하기" />
									<input type="reset" class="small issue_list_detail" value="리셋">
									<input type="button" class="small issue_list_detail" value="취소"
										onclick="location.href='calendar.do?command=calendar&prj_num=${prj_num_session}'">
								</td>
							</tr>
						</table>
					</form>
