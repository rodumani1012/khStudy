	...
	public static void send_find_email(String email, String user_id) {
		...
		try {
			...
			message.setContent("<style type='text/css'>" + 
					...
					"					</tr>" +
					"					<tr>" + 
					"						<td colspan='2' width='740px' style='font-family: 맑은 고딕; font-size: large;'>비밀번호도 모르시겠다면<a href='http://localhost:8787/TOY_Semiproject/home/member/find_id_pw.jsp' style='color: #79AFFA; text-decoration: none;'><b>여기</b></a>를 눌러주세요 </td>" + 
					"					</tr>" +
					"				</table>" + 
					"			</div>",
