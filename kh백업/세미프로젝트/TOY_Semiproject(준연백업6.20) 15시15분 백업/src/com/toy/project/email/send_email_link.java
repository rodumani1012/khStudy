	...
	public static void sendPassward(String prj_name, int prj_num, String invite_nick, String invite_email, String prj_user, int user_num) {
		...
		try {
			...
			message.setContent("<style type='text/css'>" + 
					...
					"			</tr>" + 
					"			<tr>" + 
					"				<td colspan='2' width='740px' style='font-family: 맑은 고딕; font-size: large;'>프로젝트에 참여하고 싶다면 <a href='http://192.168.10.139:8787/TOY_Semiproject/invite.do?command=insert_user&prj_num="+prj_num+"&user_num="+biz.bring_num(invite_nick).getUser_num()+"' style='color: #79AFFA; text-decoration: none;'><b>여기</b></a>를 눌러주세요</td>" + 
					"			</tr>" + 
					"			<tr>" + 
					"				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>" + 
					"			</tr>" + 
