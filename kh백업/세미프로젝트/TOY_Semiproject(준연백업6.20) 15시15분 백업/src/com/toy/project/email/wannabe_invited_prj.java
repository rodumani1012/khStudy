	...
	public static void want_invite(String login_nick, String prj_user, String prj_name, String email, int prj_num,
		...
		try {
			...
			message.setContent("<style type='text/css'>" + 
					...
					"					</tr>" + 
					"					<tr>" + 
					"						<td colspan='2' width='740px' style='font-family: 맑은 고딕; font-size: large;'><b style='color: #FED259;'>"+login_nick+"</b>님이 참여하길 원하신다면 <a href='http://192.168.10.139:8787/TOY_Semiproject/invite.do?command=insert_user&prj_num="+prj_num+"&user_num="+login_num+"' style='color: #79AFFA; text-decoration: none;'><b>여기</b></a>를 눌러주세요</td>" + 
					"					</tr>" + 
					"					<tr>" + 
					"						<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>" + 
					"					</tr>" + 
