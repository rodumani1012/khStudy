...
public class project_controller extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (command.equals("project_new")) {
			...
			issue_reply_dto dto = new issue_reply_dto(Integer.parseInt(request.getParameter("issue_num")),
					request.getParameter("user_nickname"), request.getParameter("reply_content"), null);

			biz.reply_insert(dto);

		} else if (command.equals("bring_reply")) {

			List<String> list = biz.bring_reply(Integer.parseInt(request.getParameter("issue_num")));
		...
		} else if (command.equals("prj_search")) {

			List<String> list = biz.prj_search(request.getParameter("select"), request.getParameter("keyword"));
