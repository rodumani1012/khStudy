		...
		<div class="inner">
			...
			<article class="box post post-excerpt">
				<section class="box recent-posts">
					...
					<input type="hidden" name="user_num" value="${user_info_dto.user_num}" />
					<header>
						<h3>프로젝트 보기</h3>
						<c:if test="${user_info_dto.user_nickname ne prj_info_dto.user_nickname}">
							<input type="button" class="small" value="신청하기" onclick="pick_me()" />
						</c:if>
					</header>
					<table>
						<tbody>
