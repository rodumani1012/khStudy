...
test('short capture', function (t) {
    t.same(
        optimist.parse([ '-h', '192.168.10.139' ]),
        { h : '192.168.10.139', _ : [], $0 : $0 }
    );
    t.end();
});
...
test('short captures', function (t) {
    t.same(
        optimist.parse([ '-h', '192.168.10.139', '-p', '555' ]),
        { h : '192.168.10.139', p : 555, _ : [], $0 : $0 }
    );
    t.end();
});
...
test('long captures sp', function (t) {
    t.same(
        optimist.parse([ '--host', '192.168.10.139', '--port', '555' ]),
        { host : '192.168.10.139', port : 555, _ : [], $0 : $0 }
    );
    t.end();
});
...
test('mixed short bool and capture', function (t) {
    t.same(
        optimist.parse([ '-h', '192.168.10.139', '-fp', '555', 'script.js' ]),
        {
            f : true, p : 555, h : '192.168.10.139',
            _ : [ 'script.js' ], $0 : $0,
        }
    );
    t.end();
