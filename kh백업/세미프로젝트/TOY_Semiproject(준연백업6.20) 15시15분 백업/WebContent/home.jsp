		...
		<div class="inner">
			...
			<article class="box post post-excerpt">
				...
				<section class="box recent-posts">
					<header>
						<h3 class="home_title" title="free">자유게시판</h3>
					</header>
					<ul>
						<%
						...
						<c:choose>
							...
							<c:otherwise>
								<c:forEach items="${free }" var="free">
									<li><a href="home.do?command=board_detail&normal_num=${free.normal_num}">${free.normal_title
											}</a></li>
								</c:forEach>
							</c:otherwise>
						</c:choose>
			...
			<article class="box post post-excerpt">
				<section class="box recent-posts">
					<header>
						<h3 class="home_title" title="project">프로젝트</h3>
					</header>
					<ul>
						<%
						...
						<c:choose>
							...
							<c:otherwise>
								<c:forEach items="${prj }" var="prj">
									<li><a href="project.do?command=project_show&prj_num=${prj.prj_num }">${prj.prj_name
											}</a></li>
								</c:forEach>
							</c:otherwise>
						</c:choose>
			...
			<article class="box post post-excerpt">
				<section class="box recent-posts">
					<header>
						<h3 class="home_title" title="crew">인원모집</h3>
					</header>
					<ul>
						<%
						...
						<c:choose>
							...
							<c:otherwise>
								<c:forEach items="${crew }" var="crew">
									<li><a href="home.do?command=board_detail&normal_num=${crew.normal_num}">${crew.normal_title
											}</a></li>
								</c:forEach>
							</c:otherwise>
						</c:choose>
			...
			<article class="box post post-excerpt">
				<section class="box recent-posts">
					<header>
						<h3 class="home_title" title="qna">질문게시판</h3>   
					</header>
					<ul>
						<%
						...
						<c:choose>
							...
							<c:otherwise>
								<c:forEach items="${qa }" var="qa">
									<li><a href="home.do?command=board_detail&normal_num=${qa.normal_num}">${qa.normal_title
											}</a></li>
								</c:forEach>
							</c:otherwise>
						</c:choose>
