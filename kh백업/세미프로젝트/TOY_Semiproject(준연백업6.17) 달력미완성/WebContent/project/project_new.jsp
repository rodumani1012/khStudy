...
<head>
	...
	<style type="text/css">
		...
		.map_wrap{width: 53%; margin-left: 40%; z-index: -1;}
        #asd {width:90px; height: 50px;}
		#map {width: 100%; height: 320px; display: none; border: 2px solid #42d9f7;}
	</style>
</head>
		...
		<div class="inner">
			...
			<section class="box search">
				<form method="post" action="../project.do">
					...
					<input type="text" class="text" name="prj_name" placeholder="프로젝트 이름" onchange="prj_name_check()" required />
					<input type="text" class="text" name="prj_invite_nick" placeholder="초대할 사람 닉네임" onchange="nick_check()" />
					<div id="nick_confirm"></div>
					<input type="text" class="text" name="prj_loc" id="address" placeholder="도로명 주소" readonly="readonly" required/>
