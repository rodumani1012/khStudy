...
//	private int[] lastDayOfMonth = {31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
	...
	// overloading Constructor : 생성자 - 객체 초기화
	public Date() {	this(2002, 2, 14);	} //this 생성자 사용
...
//		this.month = (this.month<=1)? month=1:((this.month>=12)? month=12: month);
	...
	public void setDay(int day) {
		...
		if (day < 1) {
			...
			day = lastDayOfMonth.get(month-1);  // -1을 하는 이유는 사람은 1월 2월 3월... 이지만 컴퓨터는 0월 1월 2월 .. 순이기 때문이다
